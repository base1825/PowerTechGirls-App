  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.text}>Purpose: To provide alterations and new garment tailoring service.</Text>
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    alignItems: 'center',
    padding: 20,
    paddingBottom: 120, // évite que le contenu soit masqué par la barre du bas
  },
  logo: {
    width: 120,
    height: 120,
